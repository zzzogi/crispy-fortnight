...
export default function RegisterPage() {
  ...
  // Redirect if redirect param is present
  useEffect(() => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    register({ name, email, password, redirect });
  };
    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-10 ">
        <div className="w-full max-w-md">
          ...
          {error && (
            <div className="mb-4 rounded bg-red-50 p-3 text-red-700 border border-red-100">
              {error}
            </div>
          )}

          {success && (
            <div className="mb-4 rounded bg-green-50 p-3 text-green-700 border border-green-100">
              {success}
            </div>
          )}
